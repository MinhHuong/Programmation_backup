...
Point::Point( float x, float y ) {
  nb_instance++;
  id = nb_instance;
  cout << "Point::Constructeur : " << x << " , " << y << " pour le point " << id << endl;
  my_abs = x;
  my_ord = y;
}
...
Point::Point() {
  nb_instance++;
  id = nb_instance;
  cout << "Point::Constructeur par defaut pour le point " << id << endl;
  my_abs = 0;
  my_ord = 0;
}
...
Point::Point( const Point & p ) {
  nb_instance++;
  id = nb_instance;
  cout << "Point::Constructeur par copie pour le point " << id << endl;
  my_abs = p.my_abs;
  my_ord = p.my_ord;
}
