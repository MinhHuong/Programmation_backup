...
public class PanelDepQuoti extends JPanel {
	...
	public PanelDepQuoti(TabPane tabPane)
	{
		...
		add(datePicker);
		//System.out.println(datePicker.getModel().getValue().toString());
