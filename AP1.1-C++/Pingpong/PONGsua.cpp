...
const int TAILLE_BALL = 6;
const int TAILLE_BAR_W = 11;
const int TAILLE_BAR_H = 43;
...
// ******************** LES IMAGES *********************************************
SDL_Surface* fond = loadImage("Images/fond.bmp");         //background in game
SDL_Surface* title = loadImage("Images/title.bmp");       //background in menu
SDL_Surface* button = loadImage("Images/button.bmp");     //button in menu  
SDL_Surface* loser = loadImage("Images/Loser.bmp");       // lose/win images 
SDL_Surface* winner = loadImage("Images/Winner.bmp");
SDL_Surface* main_menu = loadImage("Images/Menu.png");    // after win
SDL_Surface* player01 = loadImageWithColorKey("Images/player01.bmp", 0 , 255 , 255);  // les bar pour joueur 1 ou2
SDL_Surface* player02 = loadImageWithColorKey("Images/player02.bmp", 0 , 255 , 255);
SDL_Surface* ball = loadImageWithColorKey("Images/ball.bmp", 0 , 255 , 255);  // ball
